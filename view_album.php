...
$sql2 = "SELECT * FROM album_images where album_id = '$id'";
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="contact_dash.php">
                    <svg class="bi" aria-hidden="true">
                      <use xlink:href="contact_dash.php"></use>
                    </svg>
                    Contact Us
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="about_dash.php">
                    <svg class="bi" aria-hidden="true">
                      <use xlink:href="about_dash.php"></use>
                    </svg>
                    About Us
                  </a>
                </li>
...
>
            <h1 class="h2">Viewing Album - <?php echo $title;?></h1>
  ...
  <div class="card-body">
    ...
    <a href="view_album.php?id=<?php echo $row['id'];?>&title=<?php echo $row['title'];?>" class="btn btn-primary">View Album</a>
...
<?php 
  ...
  <div class="col-sm-2">
      <img src="<?php echo $row['file'];?>" width="100px">
  </div>
