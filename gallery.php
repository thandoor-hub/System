...
<body>
  ...
  <img src="slides/1774520423.jpg" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="card col-sm-4">
  <img src="slides/1774522564.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
...
<div class="card col-sm-4">
  <img src="slides/1774522819.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <a href="#" class="btn btn-primary">Go somewhere</a>
  </div>
