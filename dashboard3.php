          ...
          >
            ...
            >
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="gallery_dash.php">
                    <svg class="bi" aria-hidden="true">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="contact_dash.php">
                    <svg class="bi" aria-hidden="true">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="about_dash">
                    <svg class="bi" aria-hidden="true">
...
>
  ...
  <div class="user-menu">
    ...
    <div id="dropdown" class="dropdown">
      ...
      <!-- Profile Section -->
      <div class="dropdown-section profile">
      ...
      <div class="dropdown-section">
        ...
        <p class="login-time"><?php echo $_SESSION['login_date'] ?></p>
      </div>
            ...
            <div class="row">
              <div class="col-sm-4">
                <form method="post" action="process_slider.php" enctype="multipart/form-data">
                    ...
                    <div class="group">
                    <textarea class="form-control" name="desc" required>description here...</textarea>
               ...
               <table class="table table-bordered">
                <thead>
                   ...
                   <tr>
                            ...
                            <td>
                            <img src="<?php echo $row['file'];?>" width="140px"> 
                            </td>

                            <td>

                              <a class="btn btn-info" href="edit_slide.php?id=<?php echo $row['id'];?>">Edit</a>
                              <a class="btn btn-danger" href="delete_slide.php?id=<?php echo $row['id'];?>" onclick ="return checkDelete()">Delete</a>
                            </td>
                        </tr>
  ...
  window.addEventListener("click", function (e) {
    ...
    <script>
      function checkDelete(){
        return confirm("Are you sure you want to delete this ile");
      }
    </script>
