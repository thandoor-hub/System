...
//for slider img
$sql2 = "SELECT * FROM slider where id='$id' order by id DESC";
          ...
          >
            ...
            >
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" href="dashboard3.php">
                    <svg class="bi" aria-hidden="true">
                      <use xlink:href="dashboar3.php"></use>
                    </svg>
                    Orders
                  </a>
                </li>
            ...
            <div class="row">
               ...
               <table class="table table-bordered">
                   ...
                   <tr>
                            ...
                            <form method="post" action="update_slide.php?id=<?php echo $row['id'];?>">
                ...
                <table>
                 ...
                 <?php 
                  ...
                  <tr>
                <img src="<?php echo $row['file'];?>" width="150px"> 
                  </tr>
                ...
                <form method="post" action="update_slider_img.php?id=<?php echo $id;?>" enctype="multipart/form-data">
